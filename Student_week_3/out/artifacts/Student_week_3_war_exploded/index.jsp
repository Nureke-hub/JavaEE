            ...
            <div class="mt-4">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        ...
                        <%}else{%>
                        <li class="page-item">
                            <a class="page-link" href="/home?pag_page=<%=(int)request.getAttribute("current_page")-1%>" tabindex="-1">Previous</a>
                        </li>
                        <%
                            }
                        %>
                ...
                <%
                    ...
                    for(int i = 1; i <= pag_count; i++){
                        ...
                        <li class="page-item disabled"><a class="page-link" href="/home?pag_page=<%=i%>"><%=i%></a></li>
                        <%}else{%>
                        <li class="page-item"><a class="page-link" href="/home?pag_page=<%=i%>"><%=i%></a></li>
                        <%
                            }
                        }
                        %>
                        ...
                        <%}else{%>
                        <li class="page-item">
                            <a class="page-link" href="/home?pag_page=<%=(int)request.getAttribute("current_page")+1%>">Next</a>
                        </li>
